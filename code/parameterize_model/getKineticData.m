%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function [Kcats,KMs] = getKineticData(model_data,org_name)
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [Ks,Kp] = getKineticData(model_data,org_name,parameter)
...
load('../../data/TaxonomicDistance_KEGG.mat')
...
fileName_subs  = ['../../results/parameters/' param '_subs.txt'];
fileID_subs    = fopen(fileName_subs,'w');
fileName_prods = ['../../results/parameters/' param '_prods.txt'];
...
if strcmpi(parameter,'catalytic rate constant')
    ...
    fID           = fopen('../../data/BRENDA/max_KCAT.txt');
...
elseif strcmpi(parameter,'Michaelis constant')
    ...
    fID         = fopen('../../data/BRENDA/min_KM.txt');
    data_cell     = textscan(fID,'%s %s %s %f  %s','delimiter','\t');
